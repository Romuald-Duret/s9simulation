...
plt.hist(df[2], bins=100, density=True)
...
plt.figure(figsize=(12,8))
plt.hist(sorted, bins=100, density=True)
#plt.plot(df[0],label="cas reel")
plt.title("cas reel")
plt.show()
...
plt.title("Estimation de la loi de repartition exp")
plt.show()
...
plt.title("Estimation de la loi de repartition Uniforme")
plt.show()
